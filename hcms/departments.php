										...
										<tbody>
											...
											foreach ($rows as $row) {
												...
												<tr>
													...
													<td>
														<a role="button" href="edit-department.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit fa-2x text-info"></i></a>
														<a role="button" href="includes/action.php?delete=1&id=<?php echo $row['id'];?>"><i class="fa fa-trash fa-2x text-danger"></i></a>
